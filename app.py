...
# 2. BASE DE DATOS COMPLETA (Confirmada con todos tus datos)
@st.cache_data
def load_data():
    data = [
...
# 3. Sidebar (Filtros siempre visibles)
with st.sidebar:
    st.title("🎛️ Filtros")
...
# 4. Gráficas con Animación de Crecimiento
...
for _, row in df_f.iterrows():
    ...
    # Rango extendido para que no se oculte la línea suavizada
    y_max = max(y) + 5 
    ...
    # Animación de dibujo usando frames (fuerza la actualización suave)
